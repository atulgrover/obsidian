...
import { convertToPdf, convertBufferToPdf, cleanupConversionFiles, guessExtensionFromBuffer, } from "../conversion/convertToPdf.js";
...
export class LiteParse {
     ...
     */
    async screenshot(input, pageNumbers, quiet = false) {
        const log = (msg) => {
            if (!quiet)
                console.error(msg); // Progress goes to stderr
        };
